...
<div class="login-pf-page">
    <div id="kc-header" class="login-pf-page-header">
        <div id="kc-header-wrapper" class="text-center">
             <span class="h1 text-white">Sistem Autentikasi Universitas Brawijaya</span>

        </div>
    </div>
    <div class="card-pf border-0 rounded-0 shadow bg-body p-2 p-md-4">
        <header class="login-pf-header text-primary">
                <h1 id="kc-page-title" class="h4"><strong>        Selamat kamu berhasil register 
</strong></h1>
      </header>
      <div id="kc-content">
